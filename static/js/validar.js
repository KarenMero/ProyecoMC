...
// isName (s [,eok])                   s es un nombre o apellido
//
// FUNCIONES INTERNAS:
//
...
var mMessage = "Error: No puede dejar este espacio vac�o."

// p abrevia "prompt"
var pPrompt = "Error: ";
var pAlphanumeric = "Ingrese un texto que contenga solo letras y/o n�meros";
var pAlphabetic   = "Ingrese solo el primer nombre que contenga solo letras sin espacios";
var pInteger = "Ingrese un n�mero entero.";
var pNumber = "Ingrese un n�mero.";
var pPhoneNumber = "Ingrese un n�mero de tel�fono.";
var pEmail = "Ingrese una direcci�n de correo electr�nico v�lida";
var pName = "Ingrese un texto que contenga solo letras, n�meros o espacios";
...
// notificar que el campo theField es inv�lido
...
// Verifica si el campo especificado es valido o no
function checkField (theField, theFunction, emptyOK, s)
{
    ...
    if (checkField.arguments.length == 4) {
        ...
        if( theFunction == isPhoneNumber ) msg = pNumber;//pPhoneNumber;
